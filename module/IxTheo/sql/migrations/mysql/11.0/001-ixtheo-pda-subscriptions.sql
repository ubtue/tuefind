...
ALTER TABLE ixtheo_pda_subscriptions ADD COLUMN user_id INT DEFAULT NULL AFTER id;
...
ALTER TABLE ixtheo_pda_subscriptions MODIFY COLUMN user_id INT NOT NULL;
