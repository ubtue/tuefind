...
class GetItemCollapseAndExpand extends \VuFind\AjaxHandler\AbstractBase
{
    /**
     * Record loader
     *
     ...
     * @return array
     */
    public function getItemCollapseAndExpand($id, $source, $searchId)
    {
    ...
    public function handleRequest($params)
    {
        ...
        return $this->getItemCollapseAndExpand();
    }
}
