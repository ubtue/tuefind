...
class PluginManager extends \VuFind\Search\Params\PluginManager {
    ...
    protected function _addAliasesAndFactories()
    {
        ...
        $this->aliases['solr'] = \VuFindCollapseExpand\Search\Solr\Params::class;
        $this->factories[\VuFindCollapseExpand\Search\Solr\Params::class] = '\VuFindCollapseExpand\Search\Params\Factory::getSolr';
    }
}
