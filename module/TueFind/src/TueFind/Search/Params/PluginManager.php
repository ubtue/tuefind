...
class PluginManager extends \VuFind\Search\Params\PluginManager {
    ...
    protected function _addAliasesAndFactories()
    {
        ...
        $this->aliases['solr'] = \VufindCollapseAndExpand\Search\Solr\Params::class;
        $this->factories[\VufindCollapseAndExpand\Search\Solr\Params::class] = '\VufindCollapseAndExpand\Search\Params\Factory::getSolr';
    }
}
