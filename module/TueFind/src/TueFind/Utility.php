...
class Utility
{
    public const BIN_DIR = '/usr/local/bin';
    public const BSZ_DATEN_DIR = '/usr/local/ub_tools/bsz_daten';
    public const LOG_DIR = '/usr/local/var/log/tuefind';
    public const TUELIB_DIR = '/usr/local/var/lib/tuelib';
