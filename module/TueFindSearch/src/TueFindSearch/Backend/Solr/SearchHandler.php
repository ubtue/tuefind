...
class SearchHandler extends \VuFindSearch\Backend\Solr\SearchHandler
{
    ...
    public const TIME_ASPECTS_COMMAND = \TueFind\Utility::BIN_DIR . '/time_aspects_to_codes_tool';
    public const TIME_ASPECTS_RANGE_MIN = 0;
    public const TIME_ASPECTS_RANGE_MAX = 199999999999;
    public const TIME_RANGE_PARSER = 'timeAspectRangeParser';
    public const TIME_RANGE_BBOX_FIELD = 'time_aspect_bbox';
    public const YEAR_RANGE_BBOX_FIELD = 'year_range_bbox';
    public const YEAR_RANGE_MIN = -9999;
    public const YEAR_RANGE_MAX = 9999;
