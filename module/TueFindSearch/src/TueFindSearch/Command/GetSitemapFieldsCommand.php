...
namespace TueFindSearch\Command;
...
use TueFindSearch\Feature\GetSitemapFieldsInterface;

/**
 * Similar to VuFind getIds Command, but with sitemap-specific result fields
 */
